...
kc_data_org = pd.read_csv("src/kc_house_data.csv")
...
print (kc_x_valid.values)
print (type(kc_x_valid.values))
print (kc_x_valid.values[0].astype(int))
print (kc_y_valid.values[0].astype(int))
print (arr_x_valid[0])
print (len(arr_x_valid))
print (len(arr_y_valid))
...
p = model.predict(np.array([[2014, 12,    10,     3,     2,  1770, 14400,     1,     4,     8,  1770,     0, 1959, 98166,    47,  -122,  1900, 14400]]))
print ('predict: ', p) #[381000] (predict: 406240.6)
